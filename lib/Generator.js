...
async function wrapLoading(fn, message, ...args) {
    ...
    try {
        ...
        spinner.fail(`download template failed,please click ${chalk.cyan("https://github.com/dtd-wuhan/react-template")} to download!`)
        return { code: -1 }
    }
}
...
class Generator {
    ...
    async getRepo() {
        ...
        const { repo } = await inquirer.prompt({
            ...
            type: 'list',
            choices: repos,
            message: 'After you understand what you will do, please choose a suitable template to create project:'
        })
